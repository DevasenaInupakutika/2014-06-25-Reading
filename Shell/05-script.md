...
<div class="file" markdown="1">
~~~
297 goostats -r josie01729B.txt stats-josie01729B.txt
298 goodiff stats-josie01729B.txt /data/validated/01729.txt > 01729-differences.txt
...
> #### Unnumbering
>
> josie could also use `colrm` (short for "column removal") to remove the
...
#### josie's Pipeline: Creating a Script

An off-hand comment from her supervisor has made josie realize that
...
One thing to note about josie's script is that
