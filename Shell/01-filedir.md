...
#### Josie's Pipeline: Organizing Files

Knowing just this much about files and directories,
Josie is ready to organize the files that the protein assay machine will create.
First,
she creates a directory called `species-mars-rover`
...
> Josie names her directories "year-month-day",
...
she will call her files `JOSIE01729A.txt`, `JOSIE01812A.txt`, and so on.
All 1520 files will go into the same directory.

If she is in her home directory,
Josie can see what files she has using the command:
