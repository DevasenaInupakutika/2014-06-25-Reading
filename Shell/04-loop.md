...
#### Josie's Pipeline: Processing Files

Josie is now ready to process her data files.
...
JOSIE01736A.txt stats-JOSIE01736A.txt
...
...
though,
and Josie is worried about making mistakes,
...
After a moment, Josie realizes that since her script doesn't print anything to the screen any longer,
...
goes into `species-mars-rover/2012-07-03`,
and uses `cat stats-JOSIE01729B.txt`
...
> repeat one of those commands. For example, if Josie types this:
> 
> ~~~
> $ history | tail -5
>   456  ls -l JOSIE0*.txt
>   457  rm stats-JOSIE01729B.txt.txt
>   458  bash goostats JOSIE01729B.txt stats-JOSIE01729B.txt
>   459  ls -l JOSIE0*.txt
>   460  history
> ~~~
> 
